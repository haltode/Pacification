...
public static class CityBuilding
{
    ...
    public static float[] multiplier = new float[] {/*level 1:*/ 0.00001f, 0.00005f, 0.08f, 0.0001f, /*level 2:*/ 0.00005f, 0.0001f, 0.16f, 0.0005f, /*level 3:*/ 0.0001f, 0.0005f, 0.32f, 0.001f};
