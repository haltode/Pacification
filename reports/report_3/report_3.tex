...
%Ce projet a été un gros investissement, tant au niveau du code que du groupe. En effet, étant chef de projet, il m’a fallu diriger efficacement le groupe pour s’assurer de la réussite des objectifs. C’est une tâche importante que je suis ravi d’avoir réalisé, car elle m’a appris à mieux me débrouiller pour des projets de groupes. 
%Ensuite, au niveau du projet en lui même, j’ai adoré pouvoir découvrir et exploiter un outil comme ♡Unity♡. Cela à aussi été l’occasion de développer mes compétences en C\#. 
E%n conclusion, voir progresser ce projet de semaines en semaines est une sensation formidable, et le voir terminé me rempli de joie.
